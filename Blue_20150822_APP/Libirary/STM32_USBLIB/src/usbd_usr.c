...
extern u8 SD_IN;
u8 UDISK_CONNECTED=0;
u8 UDISK_SUSPENDED=0;
...
void USBD_USR_DeviceConfigured (void)
{
	//GUI_GotoXY(10,100);	
	//GUI_SetFont(&GUI_Font8x16);
  //GUI_DispString("USB DeviceConfigured..");
	//	bsp_ChargeOn();
	if(SD_IN==0)
	{
		SleepTime=0;
...
void USBD_USR_DeviceSuspended(void)
{
	//GUI_GotoXY(10,100);	
	//GUI_SetFont(&GUI_Font8x16);
  //GUI_DispString("USB DeviceSuspended.. ");
	//		bsp_ChargeOff();
	UDISK_CONNECTED=0;
	UDISK_SUSPENDED=1;
}
...
void USBD_USR_DeviceConnected (void)
{
	//GUI_GotoXY(10,100);	
	//GUI_SetFont(&GUI_Font8x16);
 // GUI_DispString("USB DeviceConnected.. ");
//	bsp_ChargeOn();
}
...
void USBD_USR_DeviceDisconnected (void)
{
	...
	//GUI_GotoXY(10,100);	
	//GUI_SetFont(&GUI_Font8x16);
  //GUI_DispString("USB DeviceDisconnected..");
}
/**
  * @}
  */ 
