...
//////////////////////////////////////////////////////////////////////////////////	 
//Came from AlinkTech BSP Fixed by Jerry Yang  20150313
////////////////////////////////////////////////////////////////////////////////// 	 
...
SD_Error SD_Init(void)
{
  ...
  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA|RCC_AHB1Periph_GPIOB|RCC_AHB1Periph_DMA2, ENABLE);//使能GPIOC,GPIOD DMA2时钟
  ...
  GPIO_Init(GPIOB, &GPIO_InitStructure);//PD2复用功能输出
	 ...
	 //引脚复用映射设置
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource6,GPIO_AF_SDIO); //PC8,AF12
  GPIO_PinAFConfig(GPIOA,GPIO_PinSource8,GPIO_AF_SDIO);
  GPIO_PinAFConfig(GPIOA,GPIO_PinSource9,GPIO_AF_SDIO);
  GPIO_PinAFConfig(GPIOB,GPIO_PinSource4,GPIO_AF_SDIO);
  GPIO_PinAFConfig(GPIOB,GPIO_PinSource5,GPIO_AF_SDIO);	
